...
# Save a clean copy first to AdminPortal.jsx
with open(file_path, "w", encoding="utf-8") as f:
    f.write(code)

print("Restored AdminPortal.jsx from backup.")
...
if assign_tasks_start_idx != -1:
    ...
    if main_return_idx != -1:
        # Find the last closing brace of the assign-tasks if block, which is before the main return statement
        ...
        print("Warning: Could not find main return statement.")
else:
